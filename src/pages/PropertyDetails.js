      ...
      <div className="container mx-auto min-h-[800px] mb-14">
        ...
        <div className="flex flex-col items-start gap-8 lg:flex-row">
          ...
          <form className="flex flex-col gap-y-4">
            ...
            <input  className="border border-gray-300 focus:border-violet-700 outline-none rounded w-full px-4 h-14 text-sm" type="phone" placeholder="Phone*"/>
            ...
            <div className="flex gap-x-2">
              ...
              <button className="border border-violet-700 hover:border-violet-500 text-violet-700 rounded p-4 text-sm w-full transition">Call</button>
            </div>
          </form>
          </div>
        </div>
